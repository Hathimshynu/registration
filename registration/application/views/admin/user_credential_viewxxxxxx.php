                                    ...
                                    <div class="flex-shrink-0">
                                        ...
                                        <!--<button type="button" class="btn btn-light act-inac-btn custom-toggle" data-bs-toggle="button" aria-pressed="false">-->
                                                    <?php if($square['trading_status'] == "Active"){ ?>
                                                        <a href="<?=BASEURL?>admin/change_status/<?=$square['account_id']?>/Inactive" class="btn btn-success"><i class="fa-solid fa-circle-check me-1"></i> Active</a>
                                                        <?php }else{ ?>
                                                        <a href="<?=BASEURL?>admin/change_status/<?=$square['account_id']?>/Active" class="btn btn-danger bg-danger"><i class="fa-solid fa-circle-exclamation me-1"></i>Inactive</a>
                                                        <?php } ?>
                                                    <!--</button>-->
                                                                  ...
                                                                  <form action="<?=BASEURL?>admin/update_package/<?=bin2hex($user);?>" method="post">  
                                                                    ...
                                                                    <div class="col-xxl-4 col-md-4 col-lg-4 mb-2">
                                                                        <div>
                                                                            ...
                                                                            <!--<input type="text" name="" class="form-control user-cred-details" id="" value="<?=$user1['fname']?>" readonly>-->
                                                                        </div>
                                                                    </div>
                                                                    <!--end col-->
                                                                    <div class="col-xxl-4 col-md-4 col-lg-4 mb-2">
                                                                        <div>
                                                                            ...
                                                                            <!--<input type="text" class="form-control user-cred-details" name="" id="labelInput" value="<?=$user1['username']?>" readonly>-->
                                                                        </div>
                                                                    </div>
                                                                    <!--end col-->
                                                                     ...
                                                                     <div class="col-xxl-4 col-md-4 col-lg-4 mb-2">
                                                                        <div>
                                                                            ...
                                                                            <!--<input type="text" name="" class="form-control user-cred-details" id="labelInput" value="<?=$user1['address']?>" readonly>-->
                                                                        </div>
                                                                    </div>
                                                                    <!--end col-->
                                                                    </div>
                                                                    <div class="row mt-3">
                                                                      <div class="col-xxl-4 col-md-4 col-lg-4 mb-2">
                                                                        <div>
                                                                            ...
                                                                            <!--<input type="tel" class="form-control user-cred-details" name="" id="labelInput" value="<?=$user1['phone']?>" readonly>-->
                                                                        </div>
                                                                    </div>
                                                                    <!--end col-->
                                                                      <div class="col-xxl-4 col-md-4 col-lg-4 mb-2">
                                                                        <div>
                                                                            ...
                                                                            <!--<input type="text" class="form-control user-cred-details" name="" id="labelInput" value="<?=$user1['entry_date']?>" readonly>-->
                                                                        </div>
                                                                    </div>
                                                                    <!--end col-->
                                                                     <div class="col-xxl-4 col-md-4 col-lg-4 mb-2">
                                                                        <div>
                                                                            ...
                                                                            <!--<input type="text" class="form-control user-cred-details" id="labelInput" value="<?=$bal?>" raedonly>-->
                                                                        </div>
                                                                    </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header d-flex justify-content-between">
                                    ...
                                    <div class="">
                                                                <button type="button" data-bs-toggle="modal" data-bs-target="#AddAccount" class="btn btn-success bg-success waves-effect waves-light mx-3"><i class="fa-solid fa-user-plus me-2"></i>Add Account</button>
                                                                <button type="button" data-bs-toggle="modal" data-bs-target="#MergeAccount" class="btn btn-primary bg-primary waves-effect waves-light me-4"><i class="fa-solid fa-code-merge me-2"></i>Merge Account</button>
                                                            </div>
                                </div>
                                                            ...
                                                            <div class="modal-dialog modal-dialog-centered">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <form class="needs-validation" novalidate id="regist" method="post" action="<?=BASEURL?>user/my_account">
                                                                        ...
                                                                        <div class="modal-body">
                                                                              <div class="mb-3">
                                                                                <label for="crmpwd" class="form-label">CRM Password</label>
                                                                                <input type="text" class="form-control" name="crmpwd" value="" id="" placeholder="Enter CRM Password">
                                                                            </div>
                                                                              <div class="mb-3">
                                                                                <label for="masterpwd" class="form-label">Master Password</label>
                                                                                <input type="text" class="form-control" name="masterpwd" value="" id="" placeholder="Enter Master Password">
                                                                            </div>
                                                                             <div class="mb-3">
                                                                                <label for="investorpwd" class="form-label">Investor Password</label>
                                                                                <input type="text" class="form-control" name="investorpwd" value="" id="" placeholder="Enter Investor Password">
                                                                            </div>
                                                                        </div>
                                                                        <div class=" d-flex justify-content-center">
                                                                          <div  class="mb-4">
                                                                ...
                                                                <div class="row gy-4 d-flex justify-content-center">
                                                                    ...
                                                                    <div class="col-xxl-12 col-md-12 col-lg-12 mb-2">
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            <label for="basiInput" class="form-label">Enter IBCRM ID</label>
                                                                    ...
                                                                    <div class="d-flex justify-content-center mt-3">
                                                                        <button type="submit" class="btn btn-primary waves-effect waves-light me-3"><i class="fa-solid fa-arrows-rotate me-2"></i>Update</button>
                                                            ...
                                                            <div class="live-preview">
                                                                <div class="row gy-4 d-flex justify-content-center">
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <input type="hidden" name="username" value="<?=$user;?>" class="form-control" id="">
                                                                        <input type="text" class="form-control" id=""  name="name" value="<?=$details['fname']?>">
                                                                    </div>
                                                                    </div>
                                                                  ...
                                                                  <div class="col-xxl-4 col-md-4 col-lg-4 mb-2">
                                                                    <div>
                                                                        ...
                                                                        <input type="email" class="form-control" id="labelInput" name="email" value="<?=$details['email']?>">
                                                                    </div>
                                                                 </div>
                                                                ...
                                                                <!--<div class="row">-->
                                                                 <div class="col-xxl-4 col-md-4 col-lg-4 mb-2">
                                                                    <div>
                                                                        ...
                                                                        <input type="tel" class="form-control" id="labelInput" name="phone" value="<?=$details['phone']?>">
                                                                    </div>
                                                                    </div>
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <input type="text" class="form-control" id="" name="zip" value="<?=$details['pin_code']?>">
                                                                    </div>
                                                                    </div>  
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <input type="text" class="form-control" id="" name="country" value="<?=$details['country']?>">
                                                                    </div>
                                                                    </div>
                                                                    <!--</div>-->
                                                                ...
                                                                <div class="col-xxl-4 col-md-4 col-lg-4 mb-2">
                                                                    <div>
                                                                        ...
                                                                        <input type="text" name="city" class="form-control" id="labelInput" value="<?=$details['city']?>">
                                                                    </div>
                                                                   </div>
                                                                   ...
                                                                   <div class="col-xxl-4 col-md-4 col-lg-4 mb-2">
                                                                    <div>
                                                                        ...
                                                                        <input type="text" name="state" class="form-control" id="labelInput" value="<?=$details['state']?>">
                                                                    </div>
                                                                </div>
                                                                    </div>
                                                                                        ...
                                                                                        <div class="card-body p-4">
                                                                                            ...
                                                                                            <div class="p-2">
                                                                                                <form action="#">
                                                                                                    ...
                                                                                                    <div class="mt-4">
                                                                                                        <button class="btn btn-success w-100" id="" type="submit">Reset Password</button>
                                                                                                    </div>
                                                                                                </form>
