...
<div class="row">
   <div class="col-xxl-12 col-lg-12">
      <h5 class="mb-3">Informative News</h5>
            <!-- Tab panes -->
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    <h4 class="card-title mb-0">Create a Informative News</h4>
                                </div><!-- end card header -->

                                <div class="card-body">
                                 <div class="row d-flex justify-content-center">
                                  <div class="col-lg-8">        
                                  <form action="<?=BASEURL?>admin/informative_news" method="post">    
                                    <!-- Basic Input -->
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="ckeditor-classic" name="news"></textarea>
                                    </div> <!--Tiny MCU Ends-->
                                    <!-- Input Date -->
                                    <div class="mb-3">
                                        <label for="exampleInputdate" class="form-label">Date <span><?=form_error('news_date');?></span></label>
                           ...
                           <div class="card-body" style="overflow:auto;">
                              <table id="scroll-horizontal" class="table nowrap align-middle" style="width:100%;overflow:auto;">
                                 ...
                                 <tbody>
                                     <?php 
                                     $count = 1;
                                     $news = $this->db->where('news_date >=',date('Y-m-d'))->get('informative_news')->result_array();
                                    ...
                                    <tr>
                                       ...
                                       <td><?=$ns['news'];?></td>
                                       <td><?=$ns['news_date'];?></td>
                                       <td><a href="<?=BASEURL?>admin/informative_news_status/<?=$ns['news_id'];?>" class=" icon-on btn btn-<?=$col;?> btn-sm" >
...
<div id="DeleteButtonModal" class="modal fade zoomIn" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="<?=BASEURL?>admin/delete_informative_news" method="post">
