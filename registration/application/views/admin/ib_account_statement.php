                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">IB Active Statement</h5>
                                </div>
                                <div class="card-body">
                                    <table id="scroll-horizontal" class="table nowrap align-middle" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php $count=1;
                                            $mac=$this->db->where('username',$users)->get('account')->result_array();
                                            foreach($mac as $key=>$row) { 
                                             $te=$this->db->select('SUM(credit) - SUM(debit) AS balance')->where('username',$row['username'])->get('account')->row()->balance+0;
                                            ?>
                                            <tr>
