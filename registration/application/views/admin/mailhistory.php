                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table id="scroll-horizontal" class="table nowrap align-middle" style="width:100%">
                                        ...
                                        <tbody>
                                           <?php $count=1;
                                         $mail = $this->db->order_by('user_role_id','desc')->get('mailhistory')->result_array();
                                        foreach($mail as $key => $ei)
                                        {
