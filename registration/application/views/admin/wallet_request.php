                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table id="scroll-horizontal" class="table nowrap align-middle" style="width:100%">
                                        ...
                                        <tbody>
                                        <?php
                                        $requests = $this->db->where('status','Request')->get('wallet_withdraw_request')->result_array();
                                        $count = 1;
                                        foreach($requests as $key => $req)
                                        {
                                            $wallet = $this->mt5->get_trade_balance($req['account_id']);
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-body text-center p-5">
                                                            ...
                                                            <form action="<?=BASEURL?>admin/approve_walletwithdraw" method="POST">
                                                            <div class="mt-4">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table id="scroll-horizontal2" class="table nowrap align-middle" style="width:100%">
                                        ...
                                        <tbody>
                                        <?php
                                        $history = $this->db->where('status!=','Request')->get('wallet_withdraw_request')->result_array();
                                        $countt = 1;
