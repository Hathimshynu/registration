                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">Meta Statement History</h5>
                                </div>
                                <div class="card-body">
                                    <table id="scroll-horizontal" class="table nowrap align-middle" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php 
                                               ...
                                               $ref=$this->db->where('username',$row['ref_id'])->get('user_role')->row_array();?>
                                               
                                               <tr>
                                                <td><?=$count++?></td>
                                                <td><?=$row['entry_date'];?></td>
                                                <td>
                                                    <div><strong>CRM ID:<?=$row['ref_id'];?></strong></div>
                                                    <div><strong>Name:<?=$ref['fname']." ".$ref['mname']." ".$ref['lname'];?></strong></div>
                                                    <div><strong>Email:<?=$ref['email'];?></strong></div>
                                                </td>
