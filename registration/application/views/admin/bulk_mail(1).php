                                        ...
                                        <div class="col-sm order-3 order-sm-2">
                                            <div class="hstack gap-sm-1 align-items-center flex-wrap email-topbar-link">
                                                <div class="form-check fs-14 m-0 me-2">
                                                    <input class="form-check-input" type="checkbox" name="checkall[]" value="" onclick="checkAll()" id="checkall">
                                ...
                                <div class="tab-content">
                                       ...
                                       <form>
                                             <li  <?php if ($e['selected']) { echo 'class="active"'; } ?>>   
                                               ...
                                               <div class="col-mail col-mail-2">
                                                  <a href="#"class="subject emaillist"><span class="subject-title">Hello</span> – <span class="teaser"><?=$e['email'];?> </span> </a>            
                                   ...
                                   <div class="tab-pane fade" id="pills-social" role="tabpanel" aria-labelledby="pills-social-tab">
                                    ...
                                    foreach($user as $key => $a) { ?>
                                       ...
                                       <form>
                                             <li <?php if ($a['selected']) { echo 'class="active"'; } ?>>   
                                               ...
                                               <div class="col-mail col-mail-2">
                                                  <a href="#"class="subject emaillist"><span class="subject-title">Hello</span> – <span class="teaser">Trip home from Colombo has been arranged, </span> </a>            
                                                  <div class="date">Mar 7</div>
                                               </div>
                                            </li>
                                    ...
                                    <div class="tab-pane fade" id="pills-promotions" role="tabpanel" aria-labelledby="pills-promotions-tab">
                                       ...
                                       $account=$this->db->where('user_id',$b['username'])->get('accounts')->result_array();
                                       ...
                                       <form>
                                             <li <?php if ($mt5['selected']) { echo 'class="active"'; } ?>>   
                                               ...
                                               <div class="col-mail col-mail-2">
                                                  <a href="#"class="subject emaillist"><span class="subject-title">Hello</span> – <span class="teaser"><?=$mt5['email'];?> </span> </a>            
                                                  <div class="date">Mar 7</div>
                                               </div>
                                            </li>
...
//         alert(status);
//         $.ajax({
//         url: "<?=BASEURL?>admin/mail_status",
//         type: 'POST',
//         alert(status);
//         data: {"user":id,"status":status},
//         dataType: 'json',
//         success: function(response) {
//             alert('mail status updated');
//             console.log(status);
//         },
//         error: function () {
//             alert('Failed');
...
function myFunction(username) {
    if ($("#username_" + username).is(":checked")) {
       var status = 'yes';
      }else  {
                var status = 'No';
                console.log(status);
...
function updateMailStatus(username, status) {
  $.ajax({
    type: "POST",
    url: "<?=BASEURL?>admin/update_mail_status",
    data: {
