...
<head>
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css" integrity="sha512-iecdLmaskl7CVkqkXNQ/ZH/XLlvWZOJyj7Yy7tcenmpD1ypASozpmT/E0iPtmFIB46ZmdtAc9eNBvH0H/ZpiBw==" crossorigin="anonymous" referrerpolicy="no-referrer" />
   ...
   <link href="https://cdnjs.cloudflare.com/ajax/libs/intl-tel-input/17.0.13/css/intlTelInput.css" rel="stylesheet" media="screen">
...
.reg-error span {
 ...
 /* Hide specific countries from the dropdown */
    .iti__country[data-country-code="af"],
    .iti__country[data-country-code="al"],
    .iti__country[data-country-code="ao"],
    .iti__country[data-country-code="bs"],
    .iti__country[data-country-code="bb"],
    .iti__country[data-country-code="bw"],
    .iti__country[data-country-code="kh"],
    .iti__country[data-country-code="ci"],
    .iti__country[data-country-code="ua-crimea"],
    .iti__country[data-country-code="cu"],
    .iti__country[data-country-code="kp"],
    .iti__country[data-country-code="cd"],
    .iti__country[data-country-code="gh"],
    .iti__country[data-country-code="is"],
    .iti__country[data-country-code="ir"],
    .iti__country[data-country-code="iq"],
    .iti__country[data-country-code="jm"],
    .iti__country[data-country-code="lr"],
    .iti__country[data-country-code="mu"],
    .iti__country[data-country-code="mn"],
    .iti__country[data-country-code="mm"],
    .iti__country[data-country-code="ni"],
    .iti__country[data-country-code="pa"],
    .iti__country[data-country-code="so"],
    .iti__country[data-country-code="sd"],
    .iti__country[data-country-code="sy"],
    .iti__country[data-country-code="tt"],
    .iti__country[data-country-code="ug"],
    .iti__country[data-country-code="ye"],
    .iti__country[data-country-code="zw"] {
...
<body>
    ...
    <div style="background-color: #20604f;"  class="auth-page-wrapper pt-0">
        ...
        <div class="auth-page-content">
            ...
            <ul class="nav nav-pills progress-bar-tab custom-nav" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link rounded-pill active" data-progressbar="registration-progress-bar" id="pills-gen-info-tab" data-bs-toggle="pill" data-bs-target="#pills-gen-info" type="button" role="tab" aria-controls="pills-gen-info" aria-selected="true" disabled>1</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link rounded-pill" data-progressbar="registration-progress-bar" id="pills-info-desc-tab" data-bs-toggle="pill" data-bs-target="#pills-info-desc" type="button" role="tab" aria-controls="pills-info-desc" aria-selected="false" tabindex="-1"  disabled >2</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link rounded-pill success" data-progressbar="registration-progress-bar" id="pills-success-tab" data-bs-toggle="pill" data-bs-target="#pills-success" type="button" role="tab" aria-controls="pills-success" aria-selected="false" tabindex="-1" disabled ><span class="tick-icon">✓</span></button>
                </li>
            </ul>
        </div>
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active " id="pills-gen-info" role="tabpanel" aria-labelledby="pills-gen-info-tab">
                <div class="row">
                    ...
                    <div class="mb-3">
                       ...
                       <div class="form-group">
                                <input type="text" id="whatsapp_code" class="form-control" placeholder="Phone Number" name="whats_num">
                                <input type="hidden" id='whats' name="whats">
                            </div>
                ...
                <div class="mt-3 text-center">
                    <p class="mb-0"><span class="text-white">Already have an account? </span><a style="color:#E1211F;" href="<?=BASEURL?>user/index" class="fw-semibold ms-1">Sign in</a></p>
                </div>
            </div>
            <!-- end tab pane -->
            ...
            <div class="tab-pane fade" id="pills-info-desc" role="tabpanel" aria-labelledby="pills-info-desc-tab">
                <div class="row">
                    ...
                    <div class="mb-3 col-lg-12">
                      ...
                      <div class="mb-3 col-lg-6 col-6">
                        <label for="pin_code" class="form-label">Postal Code<small class="ms-1 fs-11">(Optional)</small></label>
                    ...
                    <div class="mb-3 col-lg-6 col-6">
                        <label for="city" class="form-label">City </label>
                        <input type="text" class="form-control" id="city" name="city" value="<?=$this->input->post('city');?>" autocomplete="off" placeholder="Enter City Name" >
                        <div id="cityerror" class="reg-error"></div>
                    </div>

                    <div class="mb-3 col-lg-6 col-6">
                        <label for="country" class="form-label">Country</label>
                        <input type="text" class="form-control" id="country" name="country" value="<?=$this->input->post('country');?>" autocomplete="off" placeholder="Enter Country Name" >
                    ...
                    <div class="mb-3 col-lg-6 col-12 was-validated">
                        <label class="form-label" for="id-upload">Please upload the ID<small style="color:#bdc3c7;" class="ms-1">(Max file size 2MB)</small></label>
                     ...
                     ?>
                        <div class="col-lg-6">
                        <div class="mb-3">
                            <label for="ref_id" class="form-label">IB ID <span class="text-danger">*</span></label>
            ...
            <div class="tab-pane fade" id="pills-success" role="tabpanel" aria-labelledby="pills-success-tab">
                    <div class="text-center">
                        <div style="margin-top:-13px;" class="mb-0 mb-sm-0 mb-lg-2 congo-icon">
                        ...
                        <!--<p class="text-white pt-1">To access your account, Please do this little thing.<img style="width:35px;" src="<?=BASEURL?>assets/images/emojis/simple-smile.png" class="ms-1"></p>-->
                        <div class="credential-container mt-2">
                            <div class="row d-flex justify-content-center mb-0 pb-0 pt-1">
                                <div class="col-lg-6 mb-0 pb-0">
                                    <div class="card text-center credential-card mb-0 pb-0">
                                        ...
                                        <p class="cred-details"><span style="color:#20604f;">Email :</span> <span id='emailid' style="color:#ff0000;"></span> </p>
                        ...
                        <a id="loginbtn" href="<?=BASEURL?>user" type="button" class="btn mt-3 mt-sm-3 mt-lg-3 btn-success login-btn btn-label waves-effect waves-light rounded-pill"><i class=" ri-account-circle-fill label-icon align-middle rounded-pill fs-18 me-2"></i> Login</a>
                    </div>
            </div>
            <!-- end tab pane -->
        </div>
...
<!--<script src="<?=BASEURL?>assets/js/intlTelInput-jquery.min.js"></script>-->

<script>
   // Select all <span> elements within the <div> elements with class name "reg-error"
var spans = document.querySelectorAll('.reg-error span');

// Apply the style attribute to each <span> element
for (var i = 0; i < spans.length; i++) {
  spans[i].setAttribute('style', 'color: #C6BFBF !important;');
}
...
var whatsappInput = document.querySelector("#whatsapp_code");
var phoneHiddenInput = document.querySelector("#mobile");
var whatsappHiddenInput = document.querySelector("#whats");
var countryInput = document.querySelector("#country");

var phoneOptions = {
  separateDialCode: true,
  initialCountry: "in", // Set the default country code to India
...
var phone = intlTelInput(phoneInput, phoneOptions);
var whatsapp = intlTelInput(whatsappInput, phoneOptions);

// Set the initial country code in the hidden mobile field on page load
phoneHiddenInput.value = "+91"; 
whatsappHiddenInput.value = "+91"; 

// Function to set the selected country code in the hidden field
function setCountryCode(hiddenInput, selectedCountry) {
  if (selectedCountry && selectedCountry.dialCode) {
    hiddenInput.value = "+" + selectedCountry.dialCode;
...
// Function to update the hidden field with the typed number
function updatePhoneNumber(hiddenInput, phoneNumber) {
  hiddenInput.value = hiddenInput.value.split(" ")[0] + " " + phoneNumber;
}


// Initialize the hidden fields and update on country selection change
phoneInput.addEventListener("countrychange", function() {
  setCountryCode(phoneHiddenInput, phone.getSelectedCountryData());
});

whatsappInput.addEventListener("countrychange", function() {
  setCountryCode(whatsappHiddenInput, whatsapp.getSelectedCountryData());
});

// Update the hidden field with the typed number
phoneInput.addEventListener("input", function() {
  updatePhoneNumber(phoneHiddenInput, phoneInput.value);
});

whatsappInput.addEventListener("input", function() {
  updatePhoneNumber(whatsappHiddenInput, whatsappInput.value);
});

// Trigger the updatePhoneNumber function on Next page click
...
// Function to update the country name in the country field
function updateCountryName() {
  var selectedCountryData = phone.getSelectedCountryData();
  countryInput.value = selectedCountryData.name;
}

// Initialize the country name on page load
updateCountryName();

// Update the country name on country selection change
phoneInput.addEventListener("countrychange", function() {
  updateCountryName();
});
</script>
    ...
    $.ajax({
      ...
      success: function(response) {
        if (response.status === "success") {
         // Enable the "pills-info-desc-tab" button
        //  $('#pills-info-desc-tab').prop('disabled', false).removeAttr('tabindex');
        //  $('#pills-info-desc-tab').removeClass('disabled');
        ...
        //   $("#NextPage").html('NextPage').addClass("ri-arrow-right-line label-icon align-middle fs-16 ms-2");
        $("#NextPage").addClass("btn btn-success btn-label right ms-auto nexttab-btn nexttab nexttab").html('<i class="ri-arrow-right-line label-icon align-middle fs-16 ms-2"></i>Next Page')
        .css({
            "color": "white",
      ...
      $.ajax({
        ...
        success: function(response) {
          if (response.status === "success") {
           ...
           var url = '<?=BASEURL?>user/login?username=' + userId + '&password=' + password;
            ...
            // $("#sbmt").html('Submit');
            $("#sbmt").addClass("nexttab-btn nexttab-submit-button btn btn-success btn-label right ms-auto nexttab nexttab").html('<i class="fa-regular fa-circle-check label-icon align-middle fs-16 ms-2"></i>Submit');
          }
        },
        error: function(xhr, status, error) {
          // Handle AJAX request errors
...
const phoneIn = document.querySelector('input[name="phone"]');
...
phoneIn.addEventListener('input', hidePhoneError);
...
<!--on type pincode means show the city -->
<script>
...
// Validate the WhatsApp number input
whatsappInput.addEventListener("input", function() {
  whatsappInput.value = whatsappInput.value.replace(/\D/g, ""); // Remove non-numeric characters
});
</script>
