                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header d-flex justify-content-between">
                                    ...
                                    <a href="<?=BASEURL?>admin/create_account" type="button" class="btn btn-danger bg-gradient waves-effect waves-light create-acc-btn"><i class="fa-solid fa-user-plus me-2"></i>Create Account</a>
                                </div>
                                <div class="card-body">
                                    <table id="scroll-horizontal" class="table nowrap align-middle" style="width:100%">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?=$count++?></td>
                                               <td>
                                                   <div><strong>CRM ID: </strong><?=$user['username']?> <a class="edit-item-btn" href="<?=BASEURL?>admin/user_credential_view"><i class="ri-pencil-fill align-bottom text-muted"></i></a></div>
                                                ...
                                                <td>
                                                 <?php if($user['ref_id'] != ""){ ?>   
                                                   ...
                                                   <div><strong>Name: <?=$ref_details['fname']." ".$ref_details['mname']."".$ref_details['lname']?></strong></div>
                                                   <div><strong>Email: <?=$ref_details['email']?></strong></div>
                                                ...
                                                <td>$<?=$wallet;?> <a class="edit-item-btn" id="walletmo" data-muser="<?=$user['username']?>" href="#balanceModal" data-bs-toggle="modal"><i class="ri-pencil-fill align-bottom text-muted"></i></a></td>
                                                 ...
                                                 <td>
                                                    <div><a href="<?=BASEURL?>admin/user_credential_view">Send Mail</a></div>
                                                    <div>
