                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table id="scroll-horizontal" class="table nowrap align-middle" style="width:100%">
                                        ...
                                        <tbody>
                                        <?php
                                        $requests = $this->db->where('status','Request')->get('withdraw_request')->result_array();
                                        $count = 1;
                                        foreach($requests as $key => $req)
                                        {
                                            ...
                                            $wallet = $this->db->select('sum(credit) - sum(debit) as balance')->where('user_id',$req['user_id'])->get('e_wallet')->row()->balance+0;
                                        ?>    
                                            <tr>
                                                ...
                                                <td><?=$user['fname']." ".$user['lname'];?></td>
                                                 <td><?=$req['mode']?></td>
                                                 <td>    
                                                  <?php if($req['mode'] == 'Bank Transfer'){ ?>
                                                      <?=$req['acc_name'];?> 
                                                     <br>
                                                      <?=$req['acc_no'];?>
                                                     <br> 
                                                     <?=$req['ifsc'];?>  
                                                  <?php }else if($req['mode'] == 'UPI'){?>
                                                       <?=$req['wallet_address'];?> 
                                                  <?php }else{ ?>
                                                      <?=$req['wallet_address'];?> 
                                                  <?php } ?>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-body text-center p-5">
                                                            ...
                                                            <form action="<?=BASEURL?>admin/approve_withdraw" method="POST">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table id="scroll-horizontal2" class="table nowrap align-middle" style="width:100%">
                                        ...
                                        <tbody>
                                        <?php
                                        $history = $this->db->where('status!=','Request')->get('withdraw_request')->result_array();
                                        $countt = 1;
                                        ...
                                        ?>     
                                            <tr>
                                                ...
                                                <td><?=$userr['fname']." ".$userr['lname'];?></td>
                                                 <td><?=$his['mode'];?></td>
                                                 <td>    
                                                  <?php if($his['mode'] == 'Bank Transfer'){ ?>
                                                      <?=$his['acc_name'];?> 
                                                     <br>
                                                      <?=$his['acc_no'];?>
                                                     <br> 
                                                     <?=$his['ifsc'];?>  
                                                  <?php }else if($his['mode'] == 'UPI'){?>
                                                       <?=$his['wallet_address'];?> 
                                                  <?php }else{ ?>
                                                      <?=$his['wallet_address'];?> 
                                                  <?php } ?>
