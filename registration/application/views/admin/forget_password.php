                  ...
                  <div class="col-md-8 col-lg-8 col-xl-5">
                     <div class="card mt-4">
                        <div class="card-body p-4">
                           ...
                           <div class="p-2">
                              <form method="post" action="<?=BASEURL?>admin/send_otp">
                                  <div class="row">
                     ...
                     <div class="mt-4 text-center">
                        <p class="mb-0">Wait, I remember my password... <a href="<?=BASEURL?>admin" class="fw-semibold text-primary text-decoration-underline"> Click here </a> </p>
                     </div>
                  </div>
               </div>
               <!-- end row -->
